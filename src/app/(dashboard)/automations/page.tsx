            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start glass-card p-4 text-left transition-all hover:scale-[1.01] hover:border-primary/50 hover:bg-slate-900/80"
                >
...
function AutomationCard({
  ...
  return (
    <li className="glass-card transition-all hover:border-slate-700">
